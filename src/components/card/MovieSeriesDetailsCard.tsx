...
import type { MovieSeriesDetailsCardProps } from "../../types";

const MovieSeriesDetailsCard = ({ msDetails }: MovieSeriesDetailsCardProps) => {
    return (
        <>
                    ...
                    <div className="row align-items-start">
                        <div className="col-md-4 text-center">
                            <div className="poster-card mx-auto">
                                <img loading="lazy" src={msDetails.msPoster} className="img-fluid card-details-img" alt={msDetails.msName}
                                />
                                {
                                    msDetails.msLink === "/" ? (
